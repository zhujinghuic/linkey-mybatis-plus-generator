...
public abstract class AbstractTemplateEngine {
    ...
    public AbstractTemplateEngine batchOutput() {
        try {
            ...
            for (TableInfo tableInfo : tableInfoList) {
                ...
                String enumName = tableInfo.getEnumName();
                // enum
                if (null != enumName && null != pathInfo.get(ConstVal.ENUM_PATH)) {
                    String enumFile = String.format((pathInfo.get(ConstVal.ENUM_PATH) + File.separator + "%s" + suffixJavaOrKt()), enumName);
                    if (isCreate(FileType.ENUM, enumFile)) {
                        writer(objectMap, templateFilePath(template.getEnumName(getConfigBuilder().getGlobalConfig().isKotlin())), enumFile);
                    }
                }
                // MpMapper.java
    ...
    public Map<String, Object> getObjectMap(TableInfo tableInfo) {
        ...
        objectMap.put("enum", tableInfo.getEnumName());
